...
namespace PurpleSharp.Lib
{
    class SharpRoast
    {
        ...
        public static void GetDomainSPNTicket(string samaccountname, string spn, string userName = "user", string distinguishedName = "", Lib.Logger logger = null)//, System.Net.NetworkCredential cred = null)
        {
